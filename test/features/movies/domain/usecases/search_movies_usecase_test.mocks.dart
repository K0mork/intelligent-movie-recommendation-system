...
// in movie_recommend_app/test/features/movies/domain/usecases/search_movies_usecase_test.dart.
...
class MockMovieRepository extends _i1.Mock implements _i2.MovieRepository {
  ...
  @override
  _i3.Future<List<_i4.Movie>> searchMovies(
    String? query, {
    int? page,
  }) =>
      (super.noSuchMethod(
        ...
        returnValueForMissingStub: _i3.Future<List<_i4.Movie>>.value(<_i4.Movie>[]),
