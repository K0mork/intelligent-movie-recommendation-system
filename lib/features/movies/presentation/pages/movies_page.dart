    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: const [Tab(text: '人気'), Tab(text: '検索')],
        ),
      ),
      body: Column(
        children: [
          // パンくずナビゲーション
          BreadcrumbWidget(
            items: BreadcrumbHelper.createMovieBreadcrumbs(context: context),
          ),
          Expanded(
            child: TabBarView(
              controller: _tabController,
              children: [
                _PopularMoviesTab(
                  ...
                  onLoadMore: () {
                    final currentPage =
                        (movieState.popularMovies.length / 20).ceil();
                    ref
                        .read(movieControllerProvider.notifier)
